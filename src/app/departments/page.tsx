...
import { Users, UserPlus, Trash, Edit, Plus, User, BarChart, ArrowRight } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {departments.map((department) => (
            ...
            >
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-4 flex justify-between">
                <button
